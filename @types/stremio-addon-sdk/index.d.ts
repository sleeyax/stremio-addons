// Type definitions for stremio-addon-sdk 1.6.1
// Project: https://github.com/Stremio/stremio-addon-sdk
// Definitions by: Sleeyax <yourd3veloper@gmail.com>
...
export class addonBuilder {
    ...
    defineSubtitlesHandler(handler: (args: {type: ContentType, id: string, extra: {
         ...
         */
        videoSize: string
    }}) => Promise<{subtitles: Subtitle[]} & Cache>): void;
...
interface AddonInterface {
    manifest: Manifest;
    get: ({resource, type, id, extra}) => Promise<any>;
}
...
interface MetaPreview {
    ...
    logo?: string;
    /**
     *Aa few sentences describing your content.
     */
    description?: string;
}
...
interface MetaVideo {
     ...
     * 
     * Note that this is exclusive: passing video.streams means that Stremio will not request any streams from other addons for that video.
 ...
 */
export function serveHTTP(addonInterface: AddonInterface, options: {
    port?: number,
    /**
